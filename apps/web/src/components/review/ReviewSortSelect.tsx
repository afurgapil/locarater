...
const sortOptions: SortOption[] = [
  { id: "1", name: "En Yeni", value: "createdAt-desc" },
  { id: "2", name: "En Eski", value: "createdAt-asc" },
  { id: "3", name: "En Yüksek Puan", value: "rating-desc" },
  { id: "4", name: "En Düşük Puan", value: "rating-asc" },
  { id: "5", name: "Ziyaret Tarihi (Yeni-Eski)", value: "visitDate-desc" },
  { id: "6", name: "Ziyaret Tarihi (Eski-Yeni)", value: "visitDate-asc" },
  { id: "7", name: "Mekan Adı (A-Z)", value: "locationName-asc" },
  { id: "8", name: "Mekan Adı (Z-A)", value: "locationName-desc" },
];
